...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1458.1292330731135; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1309.4037916541474; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 1669.7204593748033 ; // x position of the perpendicular encoder (in tick units)
    }
